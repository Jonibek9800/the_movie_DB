...
MoviesDatails _$MoviesDatailsFromJson(Map<String, dynamic> json) =>
    MoviesDatails(
      ...
      videos: json['videos'] == null
          ? null
          : VideosDetails.fromJson(json['videos'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$MoviesDatailsToJson(MoviesDatails instance) =>
    <String, dynamic>{
...
Map<String, dynamic> _$VideosDetailsToJson(VideosDetails instance) =>
    <String, dynamic>{
